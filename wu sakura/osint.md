...
Setelah buka link website, lakukan source code untuk mencari informasi.

Ditemukan informasi seperti berikut
...
Dari situ diketahui username yang dipakai oleh attacker
...
Cari di google dari username tadi di google. Ditemukan beberapa website berikut

- https://github.com/sakurasnowangelaiko
- [https://x.com/sakuraloveraiko](https://x.com/sakuraloveraiko)
- [https://x.com/AiKOABE3](https://x.com/AiKOABE3) (didapat dari akun x di atas)

Di github, ada repo PGP, terdapat string yang diencode base64. Setelah di decode ditemukan informasi.
